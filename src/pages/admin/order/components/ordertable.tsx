...
const OrderTable = () => {
  ...
  const columns = [
    ...
    { label: "Order Item", key: "orderid" as const },
    { label: "Order ID", key: "username" as const },
    { label: "Order Status", key: "status" as const },
    {
      label: "Payment Status",
      key: "paymentstatus" as const,
      renderData: (order: Order) => {
        let textColor = "text-black"; // Default black for "Pending"
