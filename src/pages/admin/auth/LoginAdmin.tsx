          ...
          <div className="space-y-3 sm:space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 text-sm sm:text-base border border-primary rounded-full focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
